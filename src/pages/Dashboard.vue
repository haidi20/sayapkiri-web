<template>
  <main-layout>
    ...
    <div v-if="list.length <= 0 && loading" class="mt-28 mx-6 ">
      <div v-for="index in 12" :key="index" class="border border-gray-300 shadow rounded-md p-4 max-w-sm w-full inline-block m-4 ">
