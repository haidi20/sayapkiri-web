<template lang="">
    <div
      class="flex h-screen bg-gray-300 " style="background-color: #F3F4F6">      
                ...
                <ul>
                  <li class="relative">
                    <router-link
                      ...
                      to="/last-data"
                    >
                      <img src="data:image/png;base64,"/>
