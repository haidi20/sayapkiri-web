<template>
    <main-layout>
        ...
        <button type="button" @click="refresh" class="bg-white border-4 border-green-300 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline btn-refresh">
