                    ...
                    <div class="flex my-4">
                        ...
                        <div class="flex-1">
                            <div class="grid text-right">
                                ...
                                <div
                                    :class="conditionColorProfit(item.profit)" 
